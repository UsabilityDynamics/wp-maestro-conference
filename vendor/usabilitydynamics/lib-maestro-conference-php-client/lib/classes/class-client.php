    ...
    if (!class_exists('UsabilityDynamics\MC\Client')) {
        ...
        class Client {
            ...
            public function getCustomer() {
                $response = $this->request(array_filter(array(), 'getCustomer'));
            ...
            public function getActiveConference() {
                $response = $this->request(array_filter(array(), 'getActiveConference'));
                return $response['code'] == 0 ? $response : false;
            }
            ...
            public function getUpcomingConference() {
                $response = $this->request(array_filter(array(), 'getUpcomingConference'));
                return $response['code'] == 0 ? $response : false;
            }
            ...
            public function getPossibleConference() {
                $response = $this->request(array_filter(array(), 'getPossibleConference'));
                return $response['code'] == 0 ? $response : false;
            }
            ...
            public function getExpiredConference() {
                $response = $this->request(array_filter(array(), 'getExpiredConference'));
                return $response['code'] == 0 ? $response : false;
            }
            ...
            public function getCanceledConference() {
                $response = $this->request(array_filter(array(), 'getCanceledConference'));
                return $response['code'] == 0 ? $response : false;
            }
            ...
            public function createConferenceReservationless($estimatedCallers, $name = '', $contactEmail = '', $greenroom = '', $recording = '') {
                $response = $this->request(array_filter(array(
                    ...
                    'estimatedCallers' => $estimatedCallers
                                ), 'createConferenceReservationless'));
                return $response['code'] == 0 ? $response : false;
            }
             ...
             */
            public function updateConference($field, $value) {
                $response = $this->request(array_filter(array(
                    $field => $value
                                ), 'updateConference'));
                return $response['code'] == 0 ? $response : false;
             ...
             * @return array
             */
            private function request($args, $action) {
                $respone = array(
                    'code' => "0",
                    'message' => "",
                    'value' => ""
                ...
                $base_url = "http://myaccount.maestroconference.com/_access/";
                $args['customer'] = '';
                $args['key'] = '';
                $ch = curl_init();
                $Url = $base_url . $action;
